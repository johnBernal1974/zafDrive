...
import 'package:zafiro_conductor/providers/push_notifications_provider.dart';
import 'package:zafiro_conductor/src/Presentation/Forgot_PasswordPage/forgot_password_page.dart';
import 'package:zafiro_conductor/src/Presentation/Select_type_user_page/Select_type_user_page.dart';
import 'package:zafiro_conductor/src/Presentation/SingUpMoto_page/View/singUpMoto_page.dart';
import 'package:zafiro_conductor/src/Presentation/SingUp_page/View/singUp_page.dart';
import 'package:zafiro_conductor/src/Presentation/antes_inicar_page/View/antes_inicar_page.dart';
import 'package:zafiro_conductor/src/Presentation/bloqueo_page/bloqueo_page.dart';
import 'package:zafiro_conductor/src/Presentation/compartir_aplicacion_page/View/compartir_aplicacion_page.dart';
import 'package:zafiro_conductor/src/Presentation/contactanos_page/View/contactanos_page.dart';
import 'package:zafiro_conductor/src/Presentation/elegir_navegador_page/View/elegir_navegador.dart';
import 'package:zafiro_conductor/src/Presentation/eliminar_Cuenta_page/eliminar_cuenta_page.dart';
import 'package:zafiro_conductor/src/Presentation/email_verificationPage/email_verification_page.dart';
import 'package:zafiro_conductor/src/Presentation/historial_recargas_page/View/historial_recargas.dart';
import 'package:zafiro_conductor/src/Presentation/historial_viajes_page/View/historial_viajes_page.dart';
import 'package:zafiro_conductor/src/Presentation/info_permisos_page.dart';
import 'package:zafiro_conductor/src/Presentation/login_page/View/login_page.dart';
import 'package:zafiro_conductor/src/Presentation/map_driver_page/View/map_driver_page.dart';
import 'package:zafiro_conductor/src/Presentation/permisos_ubicacion_page/View/permisos_ubicacion_page.dart';
import 'package:zafiro_conductor/src/Presentation/politicas_de_privacidad_page/View/politicas_de_privacidad.dart';
import 'package:zafiro_conductor/src/Presentation/profile_page/profile_page.dart';
import 'package:zafiro_conductor/src/Presentation/recargar_page/View/recargar_page.dart';
import 'package:zafiro_conductor/src/Presentation/solicitud_servicio_page/solicitud_servicio_page.dart';
import 'package:zafiro_conductor/src/Presentation/splash_page/View/splash_page.dart';
import 'package:zafiro_conductor/src/Presentation/take_Photo_Cedula_Trasera/View/take_photo_cedula_trasera_page.dart';
import 'package:zafiro_conductor/src/Presentation/take_foto_perfil/take_foto_perfil.dart';
import 'package:zafiro_conductor/src/Presentation/take_photo_cedula_delantera/View/take_photo_cedula_delantera_page.dart';
import 'package:zafiro_conductor/src/Presentation/take_photo_tarjetaPropiedad_delantera_page/View/take_photo_tarjeta_propiedad_delantera_page.dart';
import 'package:zafiro_conductor/src/Presentation/take_photo_tarjetaPropiedad_trasera_page/View/take_photo_tarjeta_propiedad_trasera_page.dart';
import 'package:zafiro_conductor/src/Presentation/travel_calification_page/View/travel_calification_page.dart';
import 'package:zafiro_conductor/src/Presentation/travel_map_page/View/travel_map_page.dart';
import 'package:zafiro_conductor/src/Presentation/verifying_identity_page/View/verifying_identity_page.dart';
import 'package:zafiro_conductor/providers/push_notifications_provider.dart';
