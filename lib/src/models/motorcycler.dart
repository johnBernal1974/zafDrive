...
Motorcycler motorcyclerFromJson(String str) => Motorcycler.fromJson(json.decode(str));

String MotorcyclerToJson(Motorcycler data) => json.encode(data.toJson());
...
class Motorcycler {
  ...
  factory Motorcycler.fromJson(Map<String, dynamic> json) => Motorcycler(
    id: json["id"],
    rol: json["rol"],
