...
class _SingUpPageState extends State<SignUpPage> {
  String _dropdownValueMarca= "Chevrolet";
  String _dropdownValueModelo= "2024";
  String _dropdownValueColor= "Gris";
  String _dropdownValueTipoDocumento= "Cédula de Ciudadanía";
  String _dropdownValueTipoVehiculo= "Automovil";
  String _dropdownValueTipoServicio= "Particular";
        ...
        child: Column(
          children: [
            Container(
              ...
              margin: const EdgeInsets.only(left: 30,bottom: 5, top: 50),
              child: headerText(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  headerText(text: 'Igualmente autorizas el uso y manejo de datos personales de acuerdo a la ley 1581/22',
                      color: gris,
                      fontSize: 14,
                      fontWeight: FontWeight.w400),
                ],
  ...
  void dropdownCallbackTipoVehiculo(String? selectedValue) async {
    if(selectedValue is String){
      SharedPreferences sharepreferences = await SharedPreferences.getInstance();
      setState(() {
        _dropdownValueTipoVehiculo = selectedValue;
      });
      sharepreferences.setString('tipoVehiculo', _dropdownValueTipoVehiculo);
    }
  }

  void dropdownCallbackTipoServicio(String? selectedValue) async {
    if(selectedValue is String){
      SharedPreferences sharepreferences = await SharedPreferences.getInstance();
      setState(() {
        _dropdownValueTipoServicio = selectedValue;
      });
      sharepreferences.setString('tipoServicio', _dropdownValueTipoServicio);
    }
  }
      ...
      child: Column(
        children: [
          Container(
              ...
              child: headerText(text: '* Tipo de servicio', fontSize: 16, fontWeight: FontWeight.w700, color: primary)),
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton< String>(
                value: _dropdownValueTipoServicio,
                ...
                onChanged: dropdownCallbackTipoServicio,
                items: const [
      ...
      child: Column(
        children: [
          Container(
            alignment: Alignment.topLeft,
            margin: const EdgeInsets.only(left: 30, top: 10),
            child: headerText(text: '* Tipo de vehículo', fontSize: 16, fontWeight: FontWeight.w700, color: primary)),
          Container(
            padding: const EdgeInsets.only(left: 15, right: 15),
            decoration: BoxDecoration(
              border: Border.all(color: grisMedio),
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton< String>(
                value: _dropdownValueTipoVehiculo,
                icon: const Icon(Icons.keyboard_arrow_down),
                iconSize: 25,
                isExpanded: true,
                iconEnabledColor: primary,
                ...
                onChanged: dropdownCallbackTipoVehiculo,
                items: const [
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton< String>(
                ...
                iconEnabledColor: primary,
                style: const TextStyle(
                    color: negroLetras, fontSize: 17, fontWeight: FontWeight.w500, fontFamily: 'Gilroy'),
